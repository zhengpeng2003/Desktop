...
QT_MOC_LITERAL(3, 21, 17), // "navigateToNetwork"
QT_MOC_LITERAL(4, 39, 14), // "navigateToMqtt"
QT_MOC_LITERAL(5, 54, 13), // "navigateToLog"
QT_MOC_LITERAL(6, 68, 14) // "navigateToHelp"

    },
    "SettingsPage\0goBack\0\0navigateToNetwork\0"
    "navigateToMqtt\0navigateToLog\0"
    "navigateToHelp"
};
...
void SettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->navigateToNetwork(); break;
        case 2: _t->navigateToMqtt(); break;
        case 3: _t->navigateToLog(); break;
        case 4: _t->navigateToHelp(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPage::goBack)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SettingsPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPage::navigateToNetwork)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SettingsPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPage::navigateToMqtt)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SettingsPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPage::navigateToLog)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (SettingsPage::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsPage::navigateToHelp)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 1
void SettingsPage::navigateToNetwork()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SettingsPage::navigateToMqtt()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void SettingsPage::navigateToLog()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void SettingsPage::navigateToHelp()
{
